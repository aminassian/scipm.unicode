...
scipm.unicode.FromUTF8 = function (pos)
  local mod = math.mod
...
-- (see Markus Kuhn's UTF-8 and Unicode FAQ or RFC3629 for more info)
scipm.unicode.ToUTF8 = function(v)
  local math = math
  local n, s, b = 1, "", 0
...
scipm.unicode.Demo_FromUTF8 = function()
  print("Character code: "..(scipm.unicode.FromUTF8(editor.CurrentPos)))
end

-- demonstrate use of ToUTF8() function: display two characters based
-- on the given unicode value
scipm.unicode.Demo_ToUTF8 = function()
  editor:AppendText(scipm.unicode.ToUTF8(tonumber("0x4E2D", 16)))
  editor:AppendText(scipm.unicode.ToUTF8(tonumber("0x6587", 16)))
end

scipm.unicode.UTF16Table = function()
  scite.Open("")
  ...
  for p = 0, 65535, 32 do
    ...
    for q = p, p+31 do
      if q == 10 then ln = ln.."(\\n Newline)"
      elseif q == 13 then ln = ln.."(\\r Return)"
      elseif (q >= 55296 and q <= 57343) then ln = ln.."?"
      else ln = ln..scipm.unicode.ToUTF8(q)
      end
    end
    ln = ln.."\n"
